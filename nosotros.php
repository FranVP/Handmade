...
<div class="container">
    ...
    <div class="message">
        Uno de nuestros puntos fuertes y gran parte de lo que somos se lo debemos a las redes sociales.
    </div>
    <div class="message">
        Actualmente contamos con una gran comunidad de gente que comparte cada día nuestros diseños y contenidos,
        y contamos con mas de 1600 seguidores en las redes sociales haciéndonos parte de su día a día.
    </div>
    <h2 class="titulo2">Trabaja con nosotros</h2>
    <div class="message">
